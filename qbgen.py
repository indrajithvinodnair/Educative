...
def savequestion(s1,s2,s3):
    ...
    for i in range(len(s3)):
        ...
        #f.write("%d. %s [%d,%d]\n"%(questionnumber,s3[i][2],s3[i][0],s3[i][1]))
        questionnumber+=1
    document.save("C:\\Users\\acer\\Downloads\\flask\my_app\\static\\"+'demo.docx')
    #f.close()
    

def deleteStaticFiles():
    try:
        for file in os.listdir("C:\\Users\\acer\\Downloads\\flask\my_app\\static\\"):
          os.remove("C:\\Users\\acer\\Downloads\\flask\\my_app\\static\\"+file)
